...
# kubernetesbigdataeg/kafka-operator-bundle:$VERSION and kubernetesbigdataeg/kafka-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= kubernetesbigdataeg/kafka-operator
